        ...
        <div className="layout">
            ...
            <div className="top-bar">
                <div className="top-bar-content">
                    <div className="top-bar-left">
                        ...
                        <span>Support (+92) 301-922-9998 (MON-SAT: 3PM TO 12AM)</span>
                    </div>
                    <div className="top-bar-right">
                        ...
                        <a href="https://snapchat.com" target="_blank" rel="noopener noreferrer" className="social-icon">👻</a>
                        <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="social-icon">🎵</a>
                    </div>
                </div>
            </div>
            ...
            <header className="header">
                ...
                <nav className="header-nav-menu">
                    <Link to="/products?filter=new" className={isActive('/products') && filter === 'new' ? 'active' : ''}>NEW IN</Link>
                    <Link to="/products" className={isActive('/products') ? 'active' : ''}>70% OFF SALE ITEMS</Link>
                    <Link to="/products" className={isActive('/products') ? 'active' : ''}>MEN <span className="dropdown-arrow">▼</span></Link>
                    <Link to="/products" className={isActive('/products') ? 'active' : ''}>PLUS SIZE <span className="dropdown-arrow">▼</span></Link>
                    <Link to="/products" className={isActive('/products') ? 'active' : ''}>ACCESSORIES <span className="dropdown-arrow">▼</span></Link>
                    <Link to="/products" className={isActive('/products') ? 'active' : ''}>WOMEN</Link>
                </nav>
            </header>
